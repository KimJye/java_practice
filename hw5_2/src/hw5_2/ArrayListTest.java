...
public class ArrayListTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("hw5_2:김지혜");
		
		ArrayList <Integer> list =new ArrayList();//ArrayList<Integer>객체를 생성
		list.add(20);
		list.add(30);
		list.add(20);
		list.add(40);
		...
		System.out.println("인덱스"+index4+"의 원소="+list.remove(index4));//index4 위치의 값을 삭제하여 출력
		System.out.println(list);
	}
